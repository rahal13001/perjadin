...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gray-900 sidebar sidebar-dark accordion" id="accordionSidebar">
			...
			<!-- Nav Item - Pages Collapse Manajemen SBU -->
			<li class="nav-item">
                <a class="nav-link" href="{{ route('standards.index') }}">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>Manajemen SBU</span></a>
			</li>

			<!-- Nav Item - Pages Collapse Perjalanan Dinas -->
			<li class="nav-item">
